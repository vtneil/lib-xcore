#ifndef LIB_XCORE_LINALG_KALMAN_LUT_HPP
#define LIB_XCORE_LINALG_KALMAN_LUT_HPP
...
public:
  ...
  kf_acc(const real_t &dt, const real_t &covariance,
      ...
      : ivdt{
        ...
        F{ivdt.generate_F()}, B{make_numeric_matrix<Order, 1>()}, H{make_numeric_matrix<1, Order>({{0, 0, 1}})}, Q{numeric_matrix<Order, Order>::diagonals(covariance)}, R{numeric_matrix<1, 1>::diagonals(covariance)}, kf{kf_type(F, B, H, Q, R, make_numeric_vector<Order>(), alpha, beta)} {}
...
public:
  ...
  kf_pos_acc(const real_t &dt, const real_t &covariance,
      ...
      : ivdt{
        ...
        F{ivdt.generate_F()}, B{make_numeric_matrix<Order, 1>()}, H{make_numeric_matrix<2, Order>({{1, 0, 0}, {0, 0, 1}})}, Q{numeric_matrix<Order, Order>::diagonals(covariance)}, R{numeric_matrix<2, 2>::diagonals(covariance)}, kf{kf_type(F, B, H, Q, R, make_numeric_vector<Order>(), alpha, beta)} {}
...
#endif  //LIB_XCORE_LINALG_KALMAN_LUT_HPP
